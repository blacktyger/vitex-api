...
class VitexRestApi:
    ...
    def place_order_test(self, symbol=None, amount=None, price=None, side=None):
        ...
        params = {'symbol': symbol, 'amount': amount, 'price': price, 'side': side, 'timestamp': self.get_server_time(),
    ...
    def cancel_order(self, symbol=None, orderId=None):
        url = self.base_url + "/api/v2/order"
        params = {'symbol': symbol, 'orderId': orderId, 'timestamp': self.get_server_time(), 'key': self.key,
    ...
    def get_open_order(self, address=None, symbol=None, quoteTokenSymbol=None, tradeTokenSymbol=None, offset=None,
                       limit=None, total=None):
        url = self.base_url + "/api/v2/orders/open"
        params = {'address': address, 'symbol': symbol, 'quoteTokenSymbol': quoteTokenSymbol,
                  'tradeTokenSymbol': tradeTokenSymbol, 'offset': offset, 'limit': limit, 'total': total}
        res = requests.get(url, params)
        return res.json()

    def get_orders(self, address=None, symbol=None, quoteTokenSymbol=None, tradeTokenSymbol=None, startTime=None,
                   endTime=None, side=None, status=None, offset=None, limit=None, total=None):
        url = self.base_url + "/api/v2/orders"
        params = {'address': address, 'symbol': symbol, 'quoteTokenSymbol': quoteTokenSymbol,
                  'tradeTokenSymbol': tradeTokenSymbol, 'startTime': startTime, 'endTime': endTime, 'side': side,
                  'status': status, 'offset': offset, 'limit': limit, 'total': total}
        res = requests.get(url, params)
        return res.json()
    ...
    def get_trade_records(self, symbol=None, orderId=None, startTime=None, endTime=None, side=None, offset=None,
                          limit=None, total=None):
        url = self.base_url + "/api/v2/trades/all"
        params = {'symbol': symbol, 'orderId': orderId, 'startTime': startTime, 'endTime': endTime, 'side': side,
...
class VitexWebSocket:
    ...
    def response(self):
        ws = websocet.create_connection(self.dest_uri)
        ws.send(self.msg)
        result = ws.recv()
        ws.close()
        return result
